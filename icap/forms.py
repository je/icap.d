...
class ApplicationForm(forms.ModelForm):
    ...
    buy_warrant = forms.CharField(label='warrant approval level', required=False, max_length=10, widget=forms.TextInput(attrs={'class':'form-control form-control-sm', 'placeholder':'$000'}))
    buy_po = forms.NullBooleanField(label='completed procurement training?', required=False, widget=forms.NullBooleanSelect(attrs={'class':'form-control form-control-sm', 'autocomplete':'off'}),)
