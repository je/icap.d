...
class Application(models.Model):
    ...
    buy_warrant = models.CharField('warrant approval level', max_length=80, blank=True, null=True, help_text="What is your procurement/warrant approval level for the CY?")
    buy_po = models.CharField('procurement training', max_length=80, blank=True, null=True, help_text="Is Incident Procurement training competed?")
    qualifications = models.TextField('qualifications', max_length=10240, blank=True, null=True, help_text="", )
    remarks = models.TextField('remarks', max_length=10240, blank=True, null=True, help_text="", )
