...
urlpatterns = [
    ...
    re_path(r'^(?P<area_slug>[a-zA-Z0-9_\- ]+)/applicants/reports/$', AreaApplicantsReports, name='area_applicants_reports'),
    re_path(r'^(?P<area_slug>[a-zA-Z0-9_\- ]+)/applicants/emails/$', AreaEmails, name='area_emails'),
    ...
    re_path(r'^(?P<area_slug>[a-zA-Z0-9_\- ]+)/(?P<team_slug>[a-zA-Z0-9_\- ]+)/applicants/reports/$', TeamApplicantsReports, name='team_applicants_reports'),
